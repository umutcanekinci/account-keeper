...
def Add():
	...
	if(accType and accUsername and accEmail and accPass):
		...
		if (len(check.fetchall()) > 0):
			...
			add = db.execute("INSERT INTO accounts(account_type, account_username, account_password, account_email, account_date) VALUES ('"+accType+"', '"+accUsername+"', '"+accPass+"', '"+accEmail+"', '"+accDate+"')")   
